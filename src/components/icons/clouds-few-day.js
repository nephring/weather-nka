    ...
    return (
      <div style={{ display: "flex" }}>
        ...
        >
          <g>
            <path
              d="M109.906,204.389c-4.143,0-7.5,3.358-7.5,7.5v21.325c0,4.142,3.357,7.5,7.5,7.5c4.142,0,7.5-3.358,7.5-7.5v-21.325
            C117.406,207.747,114.049,204.389,109.906,204.389z"
            />
            <path
              d="M109.906,57.258c4.142,0,7.5-3.358,7.5-7.5V28.433c0-4.142-3.358-7.5-7.5-7.5c-4.143,0-7.5,3.358-7.5,7.5v21.325
            C102.406,53.9,105.764,57.258,109.906,57.258z"
            />
            <path
              d="M47.275,78.801c1.465,1.464,3.384,2.196,5.303,2.196c1.92,0,3.84-0.732,5.305-2.198c2.928-2.93,2.927-7.678-0.002-10.606
            L42.799,53.116c-2.932-2.929-7.68-2.928-10.607,0.002c-2.928,2.93-2.927,7.678,0.002,10.606L47.275,78.801z"
            />
            <path
              d="M183.463,130.825c0,4.142,3.357,7.5,7.5,7.5h21.324c4.143,0,7.5-3.358,7.5-7.5c0-4.142-3.357-7.5-7.5-7.5h-21.324
            C186.82,123.325,183.463,126.683,183.463,130.825z"
            />
            <path
              d="M36.334,130.825c0-4.142-3.357-7.5-7.5-7.5H7.5c-4.143,0-7.5,3.358-7.5,7.5c0,4.142,3.357,7.5,7.5,7.5h21.334
            C32.977,138.325,36.334,134.967,36.334,130.825z"
            />
            <path
              d="M167.217,80.997c1.919,0,3.839-0.732,5.304-2.197l15.076-15.076c2.929-2.929,2.929-7.678,0-10.606
            ...
            />
            <path
              d="M47.267,182.84l-15.074,15.076c-2.929,2.929-2.929,7.678,0.001,10.606c1.464,1.464,3.384,2.196,5.303,2.196
            s3.839-0.732,5.304-2.197l15.074-15.076c2.929-2.929,2.929-7.678-0.001-10.606C54.945,179.911,50.196,179.911,47.267,182.84z"
            />
            <path
              d="M168.27,130.825c0-32.189-26.186-58.377-58.373-58.377c-32.189,0-58.377,26.188-58.377,58.377
            ...
            />
            <path
              d="M239.591,184.247c-6.395-12.787-19.896-21.297-34.702-21.297c-20.344,0-37.064,15.526-38.517,35.144
